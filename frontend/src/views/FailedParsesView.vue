                        ...
                        <td class="px-lg py-md">
                            <div class="flex items-center gap-md">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="font-caption text-caption text-on-surface-variant truncate">Matched rule: {{ (tx.rule_name && tx.rule_name.trim() && tx.rule_name.trim().toLowerCase() !== 'unnamed rule') ? tx.rule_name : (tx.rule_id ? 'Unnamed Rule' : 'Unknown') }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-lg py-md">
